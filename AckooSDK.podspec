...
Pod::Spec.new do |s|
  s.name             = 'AckooSDK'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AckooSDK.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/mihirpmehta/AckooSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'mihirpmehta' => 'mihirpmehta@gmail.com' }
  s.source           = { :git => 'https://github.com/mihirpmehta/AckooSDK.git', :tag => s.version.to_s }
